...
+(BOOL)openActiveSessionWithPermissions:(id)arg1 loginBehavior:(int)arg2 isRead:(BOOL)arg3 defaultAudience:(int)arg4 completionHandler:(id)arg5;
...
+(BOOL)openActiveSessionWithPermissions:(id)arg1 allowLoginUI:(BOOL)arg2 loginBehavior:(int)arg3 isRead:(BOOL)arg4 defaultAudience:(int)arg5 completionHandler:(id)arg6;
