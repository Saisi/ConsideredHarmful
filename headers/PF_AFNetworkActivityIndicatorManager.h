...
@property (assign) int activityCount; 				//@synthesize activityCount=_activityCount - In the implementation block
...
@property (getter=isNetworkActivityIndicatorVisible,@dynamic,copy) BOOL networkActivityIndicatorVisible; 
