 ...
 * on Saturday, October 18, 2014 at 2:29:11 AM Eastern Daylight Time
...
@property (nonatomic,copy) NSObject<OS_dispatch_queue>* databaseQueue; 				//@synthesize databaseQueue=_databaseQueue - In the implementation block
